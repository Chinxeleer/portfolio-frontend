...
import { defaultSerovalPlugins, makeSerovalPlugin, rootRouteId, isNotFound, isRedirect, createSerializationAdapter, isResolvedRedirect, executeRewriteInput } from "@tanstack/router-core";
...
async function getStartManifest() {
  const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-BMQyC_3j.js");
...
async function getEntries() {
  if (cachedRouterEntry === null) {
    cachedRouterEntry = await import("./assets/router-BRzoDKqF.js");
  }
