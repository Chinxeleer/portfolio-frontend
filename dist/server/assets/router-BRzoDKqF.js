...
const appCss = "/assets/app-BFj6DXUq.css";
const seo = ({
  title,
  description,
  keywords,
...
const Route$2 = createRootRoute({
  head: () => ({
    meta: [
      ...
      ...seo({
        title: "Chinxeleer | Blessing Kodze - Software Engineer Portfolio",
...
const $$splitComponentImporter$1 = () => import("./blog-BXWTNPiG.js");
const Route$1 = createFileRoute("/blog")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-BzyXgDAv.js");
